...
export default function LojaDemoPage() {
    ...
    try {
      ...
      setChatLog((prev) => [
        ...prev,
        {
          role: "ai",
          content:
            "Ops, falha de conexão. Pode tentar novamente?",
        },
      ]);
    } finally {
      setIsLoading(false);
  ...
  const produtos = [
    ...
    {
      nome: "Coleira Anti-pulgas Eficaz",
      cat: "Acessórios",
      preco: "85.00",
      img: "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?q=80&w=300",
    },
    {
      nome: "Shampoo Pelos Macios 500ml",
      cat: "Higiene",
      preco: "32.90",
      img: "https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?q=80&w=300",
    },
    {
      nome: "Petisco Snappy Crocante",
      cat: "Petiscos",
      preco: "14.50",
      img: "https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?q=80&w=300",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 pb-12">
      ...
      <div className="bg-emerald-600 text-white text-center text-xs py-2 font-medium tracking-wide">
        ⚡ PROMOÇÃO DA SEMANA: Frete grátis para
        rações acima de 10kg na sua primeira
        compra!
      </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-1.5">
            <span className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-1">
              🏪 NutriPet
              <span className="text-emerald-600 font-normal text-sm bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
                Agro & Vet
              </span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-4 text-slate-600">
            <span className="text-xs font-medium bg-slate-100 p-2 rounded-lg border hidden sm:block">
              Demonstração de Loja Fictícia
            </span>
            ...
            <div className="relative p-2 hover:bg-slate-100 rounded-full cursor-pointer transition-colors">
              ...
              <span className="absolute -top-0.5 -right-0.5 bg-emerald-600 text-white font-bold text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                0
              </span>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-emerald-700 to-teal-800 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
          <div className="max-w-md space-y-4 relative z-10">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Cuidado completo para quem te dá
              amor incondicional.
            </h2>

            <p className="text-emerald-100 text-sm">
              Rações Premium, Medicamentos com
              orientação e o melhor Banho & Tosa
              da região.
            </p>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 mt-12 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-4 space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Banho com produtos
                hipoalergênicos, tosa na
                máquina/tesoura e hidratação de
                pelagem.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-4 space-y-1">
              <h4 className="font-bold text-slate-900">
                Consultório & Vacinação
              </h4>

              <p className="text-xs text-slate-500">
                Aplicação de vacinas importadas
                (V10, Antirrábica) e
          ...
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-4 space-y-1">
              ...
              <p className="text-xs text-slate-500">
                Antibióticos, anti-pulgas e
                suplementos controlados com total
      ...
      <section className="max-w-6xl mx-auto px-4 mt-12 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {produtos.map((prod, i) => (
            <div
              key={i}
              className="bg-white border border-slate-200 rounded-2xl p-3 flex flex-col justify-between hover:border-slate-300 transition-all shadow-sm"
            >
              <div className="space-y-2">
                <div
                  className="h-32 w-full bg-slate-100 rounded-xl bg-cover bg-center"
                  style={{
                    backgroundImage: `url('${prod.img}')`,
                  }}
                />

                <span className="text-[10px] uppercase font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded w-fit block">
                  {prod.cat}
                </span>
              ...
              <div className="flex justify-between items-center pt-3 mt-2 border-t border-slate-100">
                ...
                <button className="p-1.5 bg-slate-900 hover:bg-emerald-600 text-white rounded-lg transition-colors text-xs font-medium">
                  Comprar
                </button>
              </div>
            </div>
        ...
        <div className="fixed bottom-24 right-6 w-[90%] md:w-[400px] bg-white rounded-2xl shadow-2xl flex flex-col h-[550px] border border-slate-200 z-50 overflow-hidden animate-in fade-in slide-in-from-bottom-6 duration-200">
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-slate-50">
            {chatLog.map((msg, index) => (
              ...
              >
                <div
                  className={`rounded-2xl p-3 max-w-[85%] text-xs shadow-sm ${
                    msg.role === "user"
      ...
      <footer className="mt-16 bg-slate-900 py-12 text-center text-slate-400">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-sm mb-8 max-w-md mx-auto">
            ...
            do Brasil que vende, agenda
            serviços e gere o prontuário do
            seu Pet Shop de forma 100%
            autónoma.
          </p>
